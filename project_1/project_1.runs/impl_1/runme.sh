...
HD_PWD='/home/hieu/workspace/vhdl_pj_end/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IntegralImage.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IntegralImage.tcl -notrace
